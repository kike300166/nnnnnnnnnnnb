...
router.post('/register', function(req, res, next){
  ...
  productosModel
    ...
    .then(idClienteRegistrado=>{
      const mailOptions = { 
        from: 'MakeUp_Valenciano_Support@gmail.com', 
        to: email, 
        subject: `Bienvenido a MakeUp Valenciano`, 
        text: `Hola!!\n 
        ¡Te damos la bienvenida a MakeUp Valenciano!\n
        ...
        MakeUp Valenciano ©2024 NC. All rights reserved` 
      };
    ...
    const data = JSON.parse(JSON.stringify(response.data));
      ...
      .then(idFacturaRealizada =>{
        const mailOptions = { 
          ...
          text: `¡Hola, ${nombre}!\n\n 
          ¡Gracias por realizar tu compra en MakeUp Valenciano! Aqui la puedes ver al detalle:\n\n
